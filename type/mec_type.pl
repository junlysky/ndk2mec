...
our ($date,$time,$lon,$lat,$dep,$mb,$ms,$str1,$dip1,$rak1,$str2,$dip2,$rak2,$m1,$m2,$m3,$m4,$m5,$m6,$p_tr,$p_plu,$p_gen,$b_tr,$b_plu,$b_gen,$t_tr,$t_plu,$t_gen,$scale,$exponent,$name,$mw) = split /\s+/,$lines[$i];
# date time lon lat depth Mb Ms strike1 dip1  rake1  strike2  dip2  rake2   mrr  mtt  mpp  mrt  mrp  mtp  p_azi  p_plu  p_eigen  b_azi  b_plu  b_eigen  t_azi  t_plu  t_eigen  scale  exponent  name    
# perl中有更简洁的语句实现上一个语句
